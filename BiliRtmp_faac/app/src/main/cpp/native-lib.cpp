...
void *start(void *args) {
    ...
    do {
        ...
        // 连接服务器的时候，send audio head frame.
...
Java_com_maniu_bilirtmp_live_LivePusher_initAudioEnc(JNIEnv *env, jobject thiz, jint sample_rate,
                                                     jint channels) {
//    初始化faac编码  音频
...
extern "C"
JNIEXPORT void JNICALL
Java_com_maniu_bilirtmp_live_LivePusher_nativeSendAudio(JNIEnv *env, jobject thiz,
